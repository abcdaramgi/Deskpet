...
public class CustomMovement : MonoBehaviour
{
    ...
    private void Start() {
        ...
        customAnimator.PlayAnimation("Walk", (int)CharacterState.Walk);
    }
    ...
    private void Update() {
        ...
        if(isRecover)
        {
            ...
            if(recoverTime > 1f)
            {
                ...
                customAnimator.PlayAnimation("Idle", (int)CharacterState.Idle);
            }
        }
        ...
        if(dragAndDrop.isPickUp)
        {
            ...
            {
                isPickUp = true;
                customAnimator.PlayAnimation("Jump", (int)CharacterState.Jump);
            }
        ...
        else if(isPickUp)
        {
            ...
            customAnimator.PlayAnimation("Alert", (int)CharacterState.Alert);
        }
